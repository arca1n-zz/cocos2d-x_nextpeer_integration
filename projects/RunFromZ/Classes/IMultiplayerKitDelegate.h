...
#ifndef RunFromZ_IMultiplayerKitDelegate_h
#define RunFromZ_IMultiplayerKitDelegate_h


class IMultiplayerKitDelegate
{
public:
    virtual void DidTournamentStartWithDetails();
    /**
     ...
     */
    virtual void nextpeerDidTournamentStartWithDetails:(NPTournamentStartDataContainer *)tournamentContainer;
