...
//  Copyright (c) 2013 Alok Rao. All rights reserved.
//
...
@implementation NextPeerGameDelegate
...
-(void)nextpeerDidTournamentStartWithDetails:(NPTournamentStartDataContainer *)tournamentContainer
{
    ...
    NextpeerBridge::nextpeerDidTournamentStartWithDetails(tournamentContainer);
}
...
{
    NextpeerBridge::nextpeerWillTournamentStartWithDetail(tournamentContainer);
}
...
{
    NextpeerBridge::nextpeerDashboardWillAppear();
}
...
{
    NextpeerBridge::nextpeerDashboardDidAppear();
}
...
{
    NextpeerBridge::nextpeerDashboardWillDisappear();
...
{
    NextpeerBridge::nextpeerDashboardDidDisappear();
}
