...
#include "NextPeerMultiplayer.h"

@implementation NextPeerMultiplayerDelegate
...
NextPeerMultiplayer::NextPeerMultiplayer()
{
...
void NextPeerMultiplayer::initialize()
{
   // [Nextpeer initializeWithProductKey:@"YOUR GAME KEY HERE"
